...
exports.postForgotpasswaord = async (req, res, next) => {
  try {
    ...
    if (user) {
      ...
      const data = await axios.post(`http://65.1.109.205:3000/password/resetpassword/${id}`);
      ...
      //   html: `<a href="http://65.1.109.205:3000/password/resetpassword/${id}">Reset password</a>`,
      // };
